            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form method="POST" action="{{ route('admin.statistics.store') }}" class="space-y-6"
                            ...
                            <div>
                                ...
                                <x-text-input id="value" class="block mt-1 w-full" type="number" min="0" name="value"
                                    required autofocus value="{{ old('value') }}" />
