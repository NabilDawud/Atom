                            ...
                            <table class="w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                                ...
                                <thead class="bg-gray-900 text-white uppercase text-sm tracking-wider">
                                    <tr>
                                        ...
                                        <th class="py-3 px-6 text-left">Number Of Posts</th>
                                ...
                                <tbody class="text-gray-700 text-sm divide-y divide-gray-200"">
                                    @forelse ($categories as $category)
                                        <tr class="border-b hover:bg-gray-100 transition ">
                                            ...
                                            <td class="py-3 px-6"><a
                                                    href="{{ route('admin.categories.cat-Posts', $category->id) }}"
                                                    class="text-blue-500 hover:text-blue-700">View Posts</a></td>
                                            <td class="py-3 px-6">{{ $category->posts_count }}</td>
                                            <td
                                                class="py-3
                                                        px-6">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="py-3 px-6 text-center">No categories found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
