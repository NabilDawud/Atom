                                ...
                                <tbody class="text-gray-700 text-sm divide-y divide-gray-200"">
                                    @forelse ($portfolios as $portfolio)
                                        <tr class="border-b hover:bg-gray-100 transition ">
                                            <td class="py-3 px-6">{{ $portfolio->id }}</td>
                                            <td class="py-3 px-6">
                                                @if ($portfolio->image)
                                                    <img src="{{ asset($portfolio->image->path) }}"
                                                        alt="Portfolio Image" class="w-16 h-16 object-cover rounded">
                                                @else
                                                    <span class="text-gray-500">No Image</span>
                                                @endif
                                            </td>
                                            @if ($portfolio->link)
                                                <td class="py-3 px-6"><a href="{{ $portfolio->link }}" target="_blank"
                                                        class="text-blue-500 hover:text-blue-700">Visit Link</a></td>
                                            @else
                                                <td class="py-3 px-6"><span class="text-gray-500">No Link</span></td>
                                            @endif
                                            <td
                                                class="py-3
                                                        px-6">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="py-3 px-6 text-center">No portfolios found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
