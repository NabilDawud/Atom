            ...
            <div class="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
                <div class="flex flex-col items-center justify-center lg:flex-row">
                    <div class="rounded-full border-8 border-primary shadow-xl">
                        <img src="{{ asset('Aassets/img/blog-author.jpg') }}" class="h-48 rounded-full sm:h-56"
                            alt="author" />
                    </div>
        ...
        <div class="container py-16 md:py-20" id="services">
            ...
            <div class="grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
                <div class="group rounded px-8 py-12 shadow hover:bg-primary">
                    <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                        <div class="hidden group-hover:block">
                            <img src="{{ asset('Aassets//img/icon-development-white.svg') }}" alt="development icon" />
                        </div>
                        <div class="block group-hover:hidden">
                            <img src="{{ asset('Aassets//img/icon-development-black.svg') }}" alt="development icon" />
                        </div>
                    </div>
                ...
                <div class="group rounded px-8 py-12 shadow hover:bg-primary">
                    <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                        <div class="hidden group-hover:block">
                            <img src="{{ asset('Aassets//img/icon-content-white.svg') }}" alt="content marketing icon" />
                        </div>
                        <div class="block group-hover:hidden">
                            <img src="{{ asset('Aassets//img/icon-content-black.svg') }}" alt="content marketing icon" />
                        </div>
                    </div>
                    <div class="text-center">
                        <h3 class="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                ...
                <div class="group rounded px-8 py-12 shadow hover:bg-primary">
                    <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                        <div class="hidden group-hover:block">
                            <img src="{{ asset('Aassets//img/icon-mobile-white.svg') }}" alt="Mobile Application icon" />
                        </div>
                        <div class="block group-hover:hidden">
                            <img src="{{ asset('Aassets//img/icon-mobile-black.svg') }}" alt="Mobile Application icon" />
                        </div>
                    </div>
                    <div class="text-center">
                        <h3 class="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                ...
                <div class="group rounded px-8 py-12 shadow hover:bg-primary">
                    <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                        <div class="hidden group-hover:block">
                            <img src="{{ asset('Aassets//img/icon-email-white.svg') }}" alt="Email Marketing icon" />
                        </div>
                        <div class="block group-hover:hidden">
                            <img src="{{ asset('Aassets//img/icon-email-black.svg') }}" alt="Email Marketing icon" />
                        </div>
                    </div>
                    <div class="text-center">
                        <h3 class="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                ...
                <div class="group rounded px-8 py-12 shadow hover:bg-primary">
                    <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                        <div class="hidden group-hover:block">
                            <img src="{{ asset('Aassets//img/icon-design-white.svg') }}" alt="Theme Design icon" />
                        </div>
                        <div class="block group-hover:hidden">
                            <img src="{{ asset('Aassets//img/icon-design-black.svg') }}" alt="Theme Design icon" />
                        </div>
                    </div>
                    <div class="text-center">
                        <h3 class="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                ...
                <div class="group rounded px-8 py-12 shadow hover:bg-primary">
                    <div class="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
                        <div class="hidden group-hover:block">
                            <img src="{{ asset('Aassets//img/icon-graphics-white.svg') }}" alt="Graphic Design icon" />
                        </div>
                        <div class="block group-hover:hidden">
                            <img src="{{ asset('Aassets//img/icon-graphics-black.svg') }}" alt="Graphic Design icon" />
                        </div>
                    </div>
                    <div class="text-center">
                        <h3 class="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
        ...
        <div class="container py-16 md:py-20" id="portfolio">
            ...
            <div class="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
                <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                    <img src="{{ asset('Aassets//img/portfolio-apple.jpeg') }}" class="w-full shadow"
                        alt="portfolio image" />
                </a>
                <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                    <img src="{{ asset('Aassets//img/portfolio-stripe.jpeg') }}" class="w-full shadow"
                        alt="portfolio image" />
                </a>
                <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                    <img src="{{ asset('Aassets//img/portfolio-fedex.jpeg') }}" class="w-full shadow"
                        alt="portfolio image" />
                </a>
                <a href="/" class="mx-auto transform transition-all hover:scale-105 md:mx-0">
                    <img src="{{ asset('Aassets//img/portfolio-microsoft.jpeg') }}" class="w-full shadow"
                        alt="portfolio image" />
                </a>
            </div>
        </div>
                ...
                <div class="mx-auto w-full sm:w-3/4 lg:w-full">
                    ...
                    <div class="flex flex-wrap items-center justify-center pt-4 sm:pt-4">
                        <span class="m-8 block">
                            <img src="{{ asset('Aassets//img/logo-coca-cola.svg') }}" alt="client logo"
                                class="mx-auto block h-12 w-auto" />
                        </span>
                        <span class="m-8 block">
                            <img src="{{ asset('Aassets//img/logo-apple.svg') }}" alt="client logo"
                                class="mx-auto block h-12 w-auto" />
                        </span>

                        <span class="m-8 block">
                            <img src="{{ asset('Aassets//img/logo-netflix.svg') }}" alt="client logo"
                                class="mx-auto block h-12 w-auto" />
                        </span>

                        <span class="m-8 block">
                            <img src="{{ asset('Aassets//img/logo-amazon.svg') }}" alt="client logo"
                                class="mx-auto block h-12 w-auto" />
                        </span>

                        <span class="m-8 block">
                            <img src="{{ asset('Aassets//img/logo-stripe.svg') }}" alt="client logo"
                                class="mx-auto block h-12 w-auto" />
                        </span>
                    </div>
                </div>
            ...
            <div class="relative mx-auto mt-12 flex w-full flex-col lg:w-2/3">
                ...
                <div class="mt-8 flex flex-col text-center md:flex-row md:text-left">
                    <div class="md:w-2/5">
                        <div class="flex justify-center md:justify-start">
                            <span class="shrink-0">
                                <img src="{{ asset('Aassets//img/logo-spotify.svg') }}" class="h-auto w-32"
                                    alt="company logo" />
                            </span>
                ...
                <div class="mt-8 flex flex-col text-center md:flex-row md:text-left">
                    <div class="md:w-2/5">
                        <div class="flex justify-center md:justify-start">
                            <span class="shrink-0">
                                <img src="{{ asset('Aassets//img/logo-microsoft.svg') }}" class="h-auto w-32"
                                    alt="company logo" />
                            </span>
                            <div class="relative ml-3 hidden w-full md:block">
                                <span
                ...
                <div class="mt-8 flex flex-col text-center md:flex-row md:text-left">
                    <div class="md:w-2/5">
                        <div class="flex justify-center md:justify-start">
                            <span class="shrink-0">
                                <img src="{{ asset('Aassets//img/logo-fedex.svg') }}" class="h-auto w-32"
                                    alt="company logo" />
                            </span>
                            <div class="relative ml-3 hidden w-full md:block">
                                <span
                ...
                <div class="mx-auto w-5/6 bg-white py-16 shadow md:w-11/12 lg:py-20 xl:py-24 2xl:w-full">
                    <div class="grid grid-cols-2 gap-5 md:gap-8 xl:grid-cols-4 xl:gap-5">
                        <div class="flex flex-col items-center justify-center text-center md:flex-row md:text-left">
                            <div>
                                <img src="{{ asset('Aassets//img/icon-project.svg') }}"
                        ...
                        <div class="flex flex-col items-center justify-center text-center md:flex-row md:text-left">
                            <div>
                                <img src="{{ asset('Aassets//img/icon-award.svg') }}" class="mx-auto h-12 w-auto md:h-20"
                                    alt="icon award" />
                            </div>
                            <div class="pt-5 md:pl-5 md:pt-0">
                                <h1 class="font-body text-2xl font-bold text-primary md:text-4xl">
                        ...
                        <div
                            ...
                            <div>
                                <img src="{{ asset('Aassets/img/icon-happy.svg') }}" class="mx-auto h-12 w-auto md:h-20"
                        ...
                        <div
                            class="mt-6 flex flex-col items-center justify-center text-center md:mt-10 md:flex-row md:text-left lg:mt-0">
                            <div>
                                <img src="{{ asset('Aassets//img/icon-puzzle.svg') }}"
            ...
            <div class="container py-16 md:py-20">
                ...
                <div class="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
                    <a href="/post" class="shadow">
                        <div style="background-image: url({{ asset('Aassets/img/post-01.png') }})"
                    ...
                    <a href="/post" class="shadow">
                        <div style="background-image: url({{ asset('Aassets/img/post-02.png') }})"
                            class="group relative h-72 bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-72">
                            <span
                                class="absolute inset-0 block bg-gradient-to-b from-blog-gradient-from to-blog-gradient-to bg-cover bg-center bg-no-repeat opacity-10 transition-opacity group-hover:opacity-50"></span>
                            <span
                    ...
                    <a href="/post" class="shadow">
                        <div style="background-image: url({{ asset('Aassets/img/post-03.png') }})"
                            class="group relative h-72 bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-72">
                            <span
                                class="absolute inset-0 block bg-gradient-to-b from-blog-gradient-from to-blog-gradient-to bg-cover bg-center bg-no-repeat opacity-10 transition-opacity group-hover:opacity-50"></span>
                            <span
